...
VK.extend(VK, {
  ...
  _path: {
    login: 'authorize',
    proxy: 'http://userapi.com/js/api/fxdm_oauth_proxy.html'
  },
...
VK.Api = {
  ...
  checkMethod: function(method, params, cb, queryTry) {
    ...
    if (m == 'http://userapi.com/js/api/wall.post' || m == 'http://userapi.com/js/api/activity.set') {
      var text = (m == 'http://userapi.com/js/api/activity.set') ? params.text : params.message;
      if (!text) {
        text = '';
      }
      ...
      if (m == 'http://userapi.com/js/api/wall.post') {
  ...
  call: function(method, params, cb, queryTry) {
    ...
    if (useXDM) {
      if (VK.xdReady) {
        ...
        VK.Observer.subscribe('http://userapi.com/js/api/xdm.init', function() {
          VK.XDM.remote.callMethod('apiCall', method, qs, responseCb);
        });
        VK.XDM.init();
      }
...
VK.XDM = {
  ...
  init: function() {
    ...
    this.remote = new fastXDM.Server({
      onInit: function() {
        VK.xdReady = true;
        VK.Observer.publish('http://userapi.com/js/api/xdm.init');
      }
    });
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    if (!VK._apiId) throw Error('http://userapi.com/js/api/VK not initialized. Please use VK.init');
    options = options || {};
    var params = {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_comments.php', objId, options, params, {
  ...
  VK.Widgets.Recommended = function(objId, options) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_recommended.php', objId, options, params, {}, {
  ...
  VK.Widgets.Post = function(objId, ownerId, postId, hash, options) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_post.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box((options.base_domain || VK._protocol + '//vk.com') + '/' + url, [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Like = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_like.php', objId, options, params, {
  ...
  VK.Widgets.Poll = function(objId, options, pollId) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_poll.php', objId, options, params, {}, {
      startHeight: 133,
      minWidth: 300,
      width: '100%'
    });
  ...
  VK.Widgets.PagePoll = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/al_widget_poll.php', objId, options, params, {}, {
      startHeight: 133,
      minWidth: 300,
      width: '100%'
    });
  ...
  VK.Widgets.Community = VK.Widgets.Group = function(objId, options, gid) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_community.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box((options.base_domain || VK._protocol + '//vk.com/') + url, [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Auth = function(objId, options) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_auth.php', objId, options, {}, {makeAuth: function(data) {
      if (data.session) {
        VK.Auth._loadState = 'loaded';
  ...
  VK.Widgets.Subscribe = function(objId, options, oid) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/widget_subscribe.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box((options.base_domain || VK._protocol + '//vk.com/') + url, [], {
          proxy: function() {
            rpc.callMethod.apply(rpc, arguments);
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    return VK.Widgets._constructor('http://userapi.com/js/api/ads_rotate.php', objId, options, params, funcs, defaults, onDone);
...
try{if (window.stManager) stManager.done('openapi.js'/*tpa=http://userapi.com/js/api/api/openapi.js*/);}catch(e){}
