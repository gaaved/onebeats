...
var initCart = function(block){
	// Сохранение
    $("http://onebeats.com.ua/scripts/form .Buttons .send",block).click(function(){
        $(this).unbind();
...
var initOrderForm = function(block){
    ...
    // Оплата
    $("http://onebeats.com.ua/scripts/form .Buttons .pay",block).click(function(){
        //$(this).unbind();
        $("form",block).attr('action',$("form",block).attr('action')+'/pay');
        $("http://onebeats.com.ua/scripts/form .Buttons .send",block).click();
        return false;
    });
    // mask
